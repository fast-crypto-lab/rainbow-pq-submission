This folder contains the c-code of the implementation of the Rainbow signature scheme optimized for avx2 vector instructions.
...
Type 'make'. It will generate an executable PQCgenKAT_sign using source files from the directory specified in PROJ_DIR.
...
The single algorithms rainbow-genkey, rainbow-sign and rainbow-verify are used as follows.
  ...
  If seed_file is set, rainbow-sign uses the content of ssd_file as seed for the PRNG and outputs the used randomness in the terminal.
  (3)
  ...
  Remark: The length of the seed read in by algorithms rainbow-genkey and rainbow-sign is fixed to 48 bytes (=384 bit).
