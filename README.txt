...
amd64. More information on the content of the folder and how to use the code
can be found in Optimized_Implementation/amd64/README.txt.
-----------------------------------------------------
Alternative_Implementation
This folder contains the c-code of our implementations of Rainbow optimized for
avx2 vector instructions. More information on the content of the folders and
how to use the code can be found in Alternative_Implementation/avx2/README.txt.
-----------------------------------------------------
